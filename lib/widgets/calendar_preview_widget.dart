    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            height: 140, // Fixed height for scrollable calendar
            child: SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
                children: List.generate(
                  DateTime(currentYear, currentMonth + 1, 0).day, // Days in current month
                  (index) {
                    final dayNumber = index + 1;
                    final cellDate = DateTime(currentYear, currentMonth, dayNumber);
                    final isToday = cellDate.day == now.day &&
                                   cellDate.month == now.month &&
                                   cellDate.year == now.year;
                    final isPast = cellDate.isBefore(DateTime(now.year, now.month, now.day));

                    return Container(
                      width: 60, // Fixed width for each date
